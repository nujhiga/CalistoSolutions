...
public abstract class BinaryExpressionBuilder<TEntity> where TEntity : class, IEntity //: BaseExpressionBuilder<TEntity> where TEntity : class
{
    ...
    private static Expression<Func<TEntity, bool>> AuxAndAlsoExp(Expression<Func<TEntity, bool>> expr1, Expression<Func<TEntity, bool>> expr2)
    {
    ...
    protected virtual Expression<Func<TEntity, bool>> AndAlsoExp<TxValue, TyValue>(string xtarget, TxValue xvalue, string ytarget, TyValue yvalue)
    {
