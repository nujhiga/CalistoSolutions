...
//    {
//        var parameterr = Expression.Parameterr(typeof(TEntity));

//        var leftVisitor = new ReplaceExpressionVisitor(expr1.Parameters[0], parameterr);
//        var left        = leftVisitor.Visit(expr1.Body);

//        var rightVisitor = new ReplaceExpressionVisitor(expr2.Parameters[0], parameterr);
//        var right        = rightVisitor.Visit(expr2.Body);

//        return Expression.Lambda<Func<TEntity, bool>>(
//            Expression.AndAlso(left, right), parameterr);
//    }
