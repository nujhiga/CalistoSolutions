...
internal static class QueryExtenssions
{
                                                                  ...
                                                                  params Expression[] expressions) where TEntity : class
    {
        ...
        return query.Provider.CreateQuery<TEntity>(callTree.Reduce());
    }

    /*
    public static string GetRegularityValue(this ClRegularity regularity) => regularity switch
    {
        ClRegularity.Regular => nameof(ConsoleKey.R),
        ClRegularity.Ingress => $"{nameof(ConsoleKey.I)}{nameof(ConsoleKey.T)}",
        ClRegularity.Disabled => nameof(ConsoleKey.B),
        ClRegularity.Licence => nameof(ConsoleKey.L),
        _ => default!
    };
