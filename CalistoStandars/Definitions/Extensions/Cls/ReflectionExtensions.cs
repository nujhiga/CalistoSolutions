...
public static class ReflectionExtensions
{
    ...
    public static IEnumerable<MethodInfo> GetMethodsWith<TAttr>(this Type type) where TAttr : Attribute
    {
        return type.GetMethods().Where(m => Attribute.IsDefined(m, typeof(TAttr))).AsParallel();
    }
    ...
    public static IEnumerable<TAttr> GetAttributesWith<TAttr>(this object source) where TAttr : Attribute
    {
        var (type, _) = source.GetTypeDetails();

        return from pinfo in type.GetPropertiesWith<TAttr>()
